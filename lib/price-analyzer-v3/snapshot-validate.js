...
const SPEC_FLAG = "v3.3-full-ai-core";
...
function validateSnapshot(snapshot) {
  ...
  // SPEC: snapshot chuẩn áp dụng cho SPEC này:
  // schema.name = price_analyzer_full_snapshot
  // schema.version = 3.3-full
  ...
  // minimal structural presence (HTF + LTF in one file)
...
module.exports = { validateSnapshot, SPEC_FLAG };
