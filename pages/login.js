...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden font-mono sm:font-['Pacifico', cursive]">
            ...
            {/* Card Login */}
            <div className="relative z-10 bg-white/5 backdrop-blur-2xl border-t-8 border-b-8 border-pink-500 rounded-3xl px-6 py-10 max-w-[95vw] sm:max-w-[480px] w-full flex flex-col items-center">
        ...
        Welcome to <span className="font-extrabold">OneTool.IT.COM</span>
                ...
                <p className="text-gray-200 mb-6 text-sm text-center max-w-xs">
                    Sign in to manage your freelance stylist dashboard, appointments, and more...
                </p>
                <button
                    onClick={handleLogin}
                    className="bg-gradient-to-r from-yellow-400 via-pink-400 to-emerald-400 hover:brightness-120 text-black font-bold text-lg py-2 px-8 rounded-full shadow-xl transition-all duration-200 mb-4"
                >
