    ...
    transition duration-200 shadow-inner border border-[#2c4069]"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                    {filteredPortfolio.map((coin, index) => {
                        ...
                        return (
                            <div key={index}
                                className="rounded-[24px] border border-white/10 bg-[#0d111c]/50 backdrop-blur-xl shadow-[0_10px_20px_rgba(0,0,0,0.25),0_4px_6px_rgba(0,255,255,0.15)] 
                            transform transition-all duration-300 hover:shadow-[0_20px_40px_rgba(0,255,255,0.3)] hover:scale-[1.015] hover:-translate-y-1"
